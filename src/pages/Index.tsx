  ...
  const services = [
    {
      icon: 'Sparkles',
      title: 'Ринопластика',
      description: 'Коррекция формы носа с сохранением естественного вида',
      price: 'от 180 000 ₽'
    },
    {
      icon: 'Eye',
      title: 'Блефаропластика',
      description: 'Коррекция век для омоложения взгляда',
      price: 'от 120 000 ₽'
    },
    {
      icon: 'Smile',
      title: 'Липофилинг лица',
      description: 'Естественное омоложение собственным жиром',
      price: 'от 90 000 ₽'
    },
    {
      icon: 'Heart',
      title: 'Маммопластика',
      description: 'Коррекция формы и размера груди',
      price: 'от 250 000 ₽'
    },
    {
      icon: 'User',
      title: 'Абдоминопластика',
      description: 'Подтяжка живота и коррекция фигуры',
      price: 'от 200 000 ₽'
    },
    {
      icon: 'Zap',
      title: 'Контурная пластика',
      description: 'Безоперационная коррекция лица филлерами',
      price: 'от 15 000 ₽'
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-scale-in">
              <img 
                src="https://cdn.poehali.dev/projects/c444004a-7d03-43c6-9dc6-6b3cf0176088/files/9cb8ece5-4ab5-41e8-bc76-b747b886c62d.jpg"
                alt="Клиника"
